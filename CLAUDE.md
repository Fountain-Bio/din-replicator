...
- This project is open source. No company name, person name, or internal system detail appears in code, comments, tests, strings, paths, or docs. The one exception is the copyright holder in `LICENSE`. The bundle identifier is `org.dinreplicator.desktop`.
